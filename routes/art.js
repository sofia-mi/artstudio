...
router.get('/detailed/humor', function(req, res, next) {
    res.render('art-detailed', {
        ...
        'на шедеврах мировой классической фортепианной музыки.  Главная особенность концерта это соединение двух жанров - театрального и музыкального.' +
...
router.get('/detailed/music', function(req, res, next) {
    res.render('art-detailed', {
        ...
        ' репетиции",основанный на шедеврах классической музыки.В спектакле прозвучат произведения Моцарта,' +
